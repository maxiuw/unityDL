...
//{
  ...
  public class OSC : MonoBehaviour
  {
    ...
    // new Thread(() => {Thread.CurrentThread.IsBackground = true; Read();}).Start();
...
// #endif
	...
	{
    Debug.Log($"{key} message {ah}, {AddressTable}");
	...
	void Update() {
    // Debug.Log(ReaderRunning);
    // Debug.Log($"recieved {messagesReceived.Count} messages");
